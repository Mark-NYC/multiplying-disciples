---
title: "Prayer is Essential: 12 Key Prayer Points for Disciple Making Movements"
description: "Unlock the power of prayer in disciple making movements with these 12 key prayer points. Watch how God works through your faithful intercession."
slug: "/prayer-is-essential-12-key-prayer-points-for-disciple-making-movements/"
...
notes: >
  Migrated from WordPress post_id 7028. Removed trailing
  wp:block {"ref":11750} reusable CTA shortcode (same reusable block
  pattern removed across other Phase 3/4 migrations). Converted 2
  absolute internal links (both to disciple-making-movement-books-top-25-must-reads,
  one of which had target="_blank" rel="noopener noreferrer") and 1
  absolute link to starter-tools into relative paths. Featured image
  pexels-photo-2258251.jpeg confirmed present, used as og_image only
  (page has no inline images, matching the original).
---
...
> Jesus came to seek and save the lost, and so should we. We need to pray for the Holy Spirit to open the hearts of the lost and draw them to Jesus.
...
> We need to pray for the Holy Spirit to fill and empower us, so that we can make disciples.
