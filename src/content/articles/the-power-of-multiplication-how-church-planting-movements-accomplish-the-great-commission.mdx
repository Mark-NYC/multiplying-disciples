...
<section id="listen-power-multiplication" aria-label="Podcast: multiplication until there is no place left">

Listen to why multiplication, not addition, is what it takes to see the Great Commission actually finished.

<PodcastEmbed
  id="from-addition-to-multiplication-the-emmaus-road"
  intro="We long for disciples multiplying until there is no place left. This episode presses on the difference between adding believers and multiplying disciples and churches, the same shift that decides whether the Great Commission gets finished."
/>
...
<ArticleMediaBar
  slug="/the-power-of-multiplication-how-church-planting-movements-accomplish-the-great-commission/"
  listen={{ target: 'listen-power-multiplication', label: 'Listen' }}
