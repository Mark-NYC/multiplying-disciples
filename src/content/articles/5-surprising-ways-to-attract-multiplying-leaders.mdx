...
<section id="watch-attract-leaders" aria-label="Video: the 5 ways to attract multiplying leaders">

Watch Mark Goering walk through all five of these in a few minutes.

<div style={{ width: '100%', aspectRatio: '16 / 9', overflow: 'hidden', borderRadius: '12px' }}>
  <iframe
    src="https://www.youtube-nocookie.com/embed/d-ciGPyrqkw"
    title="Mark Goering: 5 Ways to Attract Multiplying Leaders"
    loading="lazy"
...
<section id="listen-attract-leaders" aria-label="Podcast: stop recruiting leaders, start attracting them">

Listen to the counterintuitive case behind this whole idea: you do not recruit multiplying leaders, you attract them by how you live and invest.

<PodcastEmbed
  id="5-ways-to-attract-multiplying-leaders-with-mark"
  intro="Stop recruiting leaders. In this episode Mark lays out why attraction, not recruitment, is what actually multiplies leadership, and walks through the core principles for drawing out and investing in the emerging leaders already around you."
/>
...
<ArticleMediaBar
  slug="/5-surprising-ways-to-attract-multiplying-leaders/"
  watch={{ target: 'watch-attract-leaders', label: 'Watch' }}
  listen={{ target: 'listen-attract-leaders', label: 'Listen' }}
