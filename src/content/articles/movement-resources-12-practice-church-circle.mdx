...
article_cta:
  ...
  bridge_copy: "Knowing about something and being able to lead it are two different things. A lab is where that gap closes, through practice done with others."
notes: >
...
Each of the twelve practices is tied to [one of the commands of Christ](/what-are-the-commands-of-christ/) and a short Bible story, so a new believer can obey it and hand it on to someone else.
