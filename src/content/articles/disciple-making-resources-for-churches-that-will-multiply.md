---
title: "Disciple-Making Resources for Churches That Will Multiply"
description: "Unlock the Power of Disciple-Making: Discover Game-Changing Resources for Churches. Transform Lives and Ignite a Movement Today!"
slug: "/disciple-making-resources-for-churches-that-will-multiply/"
canonical: "https://multiplyingdisciples.us/disciple-making-resources-for-churches-that-will-multiply/"
hub: "disciple-making"
related_articles:
...
notes: >
  Migrated from WordPress post_id 8445 (post). Already linked from the
  primary site nav ("Disciple Making" -> this exact URL, not the hub)
  on every page, and already reserved as the Disciple Making hub's
  next_step target and 5th key_articles slot — both now resolve to a
  real page. Removed a bizarre embedded junk placeholder block
  (`<html><head><title>Example Site - Frequently Asked Questions
  (FAQ)</title>...`), 2 duplicate pull-quote-style headings that
  repeated adjacent paragraph text verbatim, stray Elementor <style>
  blocks, and the reusable "Are you in? / Start Here. / Get Started"
  promotional CTA block (generic chrome, same pattern removed
  elsewhere). Consolidated 2 redundant, back-to-back headings/sections
  both describing the same 12-lesson PDF packet ("Complete 12 Lesson
  Disciple-Making Packet" and "Complete 12 Lesson Starter Packet")
  into one clean section. Converted the Spotify episode embed to a
  plain link. Fixed 1 broken internal link
  (`/podcast/gospel-share-your-story-in-15-seconds/`, not a real
  tracked URL) to the real, confirmed
  `/15-second-testimony-examples-ignite-your-faith/` article. Converted
  absolute internal links (`/3-circles/`, `/starter-tools/`) to
  relative. Featured image (`pexels-photo-8383470.jpeg`) and a
  decorative download-button icon (`1.webp`) are both missing from
  supplied uploads — omitted (og_image left blank; the icon was purely
  decorative next to a "DOWNLOAD - FREE" text link that already
  conveys the action). The PDF itself
  (`Church-Waffle-English-112222-1.pdf`) is present and preserved at
  its exact original path. See PHASE_7B_TIER_3_BATCH_1.md for the full
  media/chrome breakdown.
---

[Listen to the related episode on Spotify](https://open.spotify.com/episode/5p1kxOQ959G0YtGnYnuxDK)

Disciple-making lies at the core of the church's mission, as it seeks to equip believers to become fully devoted followers of Jesus Christ. To facilitate this transformative process, churches are embracing disciple-making movements, which provides [practical resources and strategies](/disciple-making-movement-books-top-25-must-reads/). Looking for disciple-making resources for churches that will multiply? In this article, we will explore the significance of disciple-making, highlight key resources from the disciple-making movement, such as the [3 Circles](/3-circles/), [Three Thirds](/three-thirds/), and Oikos mapping, and direct readers to valuable resources.

| Article Summary |
|---|
| Disciple-making is essential for the [church's mission of equipping](/equipping-your-church-for-disciple-making-movements-a-pastors-guide-to-effective-training/) believers. |
...
Effective resources should start with clear and directive teachings that lay a solid foundation of [biblical principles](/unlock-biblical-principles-for-multiplying-disciples/) and practical skills. This may include resources that provide step-by-step guidance, instructional videos, or study materials that emphasize the core elements of the faith.
...
By selecting resources that align with this biblical model, [churches can effectively equip believers to become transformational disciples](/equipping-your-church-for-disciple-making-movements-a-pastors-guide-to-effective-training/) who follow Jesus and fish for others.

## Key Resources from Disciple-Making Movements

### Complete 12 Lesson Disciple-Making Packet

This resource is a complete nineteen page disciple making packet that trains disciples to make disciples to follow Jesus and fish for people in line with the basic commands of Jesus found in the gospels. Using simple, reproducible, and Biblical tools, the contents empower disciples to train others in methods that have fruitfully multiplied in various contexts around the World.

[Download the packet here](/wp-content/uploads/2023/05/Church-Waffle-English-112222-1.pdf) for more, or read on to view a few tools highlighted from its contents.

Check out three key tools from this disciple-making packet.

### 3 Circles Gospel Tool

The 3 Circles tool simplifies the [process of sharing the gospel by using three](/three-thirds/) circles that represent God's Design, Brokenness, and the Gospel.

It enables believers to engage in natural and meaningful conversations about faith. By utilizing this tool, [churches can empower their members to confidently and effectively](/equipping-your-church-for-disciple-making-movements-a-pastors-guide-to-effective-training/) share the good news of Jesus Christ with their friends, family, and acquaintances. For more information on using the 3 Circles, [click here](/3-circles/).
...
This model fosters accountability, mutual support, and spiritual growth. To learn more about implementing the Three Thirds model, [click here](/three-thirds/).
...
Additionally, the website provides opportunities for online [training and collaboration with other churches](/equipping-your-church-for-disciple-making-movements-a-pastors-guide-to-effective-training/) and leaders who are passionate about disciple-making.

## Conclusion

Disciple-making is the heartbeat of the church, and disciple-making [movements offer powerful resources to empower churches](/equipping-your-church-for-disciple-making-movements-a-pastors-guide-to-effective-training/) and believers in this vital mission.

The 3 Circles, Three Thirds, and Oikos mapping are practical tools that enable believers to confidently [share the gospel](/15-second-testimony-examples-ignite-your-faith/), deepen their relationships with God and others, and impact their communities. By incorporating these resources into their discipleship programs and individual lives, [churches can equip their members to become transformational disciples](/equipping-your-church-for-disciple-making-movements-a-pastors-guide-to-effective-training/) of Jesus Christ.
...
Disciple-making is essential for the [church's mission of equipping](/equipping-your-church-for-disciple-making-movements-a-pastors-guide-to-effective-training/) believers for the Great Commission (Matthew 28:18-20). It equips them to obey, empowers them to impact their communities as ambassadors, and brings glory to God among every people and place.
...
Churches can explore the starter tools available on the [multiplyingdisciples.us](/starter-tools/) website and seek coaching to learn how to effectively multiply disciples, leaders, and churches in their specific context.
