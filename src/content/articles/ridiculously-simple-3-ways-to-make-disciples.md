---
title: "Ridiculously Simple: 3 Ways to Make Disciples"
description: "Transform lives and build communities with these 3 ways to make disciples. Ridiculously simple and proven methods that align with Jesus' teachings."
slug: "/ridiculously-simple-3-ways-to-make-disciples/"
canonical: "https://multiplyingdisciples.us/ridiculously-simple-3-ways-to-make-disciples/"
hub: "disciple-making"
related_articles:
...
original_url: "https://multiplyingdisciples.us/ridiculously-simple-3-ways-to-make-disciples/"
notes: >
  Migrated from WordPress post_id 7458. Converted the opening Spotify
  podcast <iframe> embed into a plain external link (Spotify episode
  2YCGz2kW9YV7eVdPGuBR75), consistent with the established YouTube-
  embed-to-plain-link pattern. Converted a raw-HTML <dl>/<dt>/<dd> FAQ
  block into a plain Markdown FAQ section (H3 questions, paragraph
  answers). Removed 2 duplicate pull-quote headings (one H4 near the
  top repeating the "Disciple making is the process..." sentence
  verbatim, one H4 mid-article repeating the "Accountability" bullet
  from the Three Thirds First Third list verbatim) — same chrome
  pattern removed across other Phase 3/4 migrations. Converted 4
  YouTube embeds to plain links. Removed a stray Elementor <style>
  block mid-article and a second one at the very end (pure chrome, no
  content). Removed the trailing wp:block {"ref":11750} reusable CTA
  shortcode (same reusable-block pattern removed elsewhere). Normalized
  heading levels: the "FIRST THIRD" / "MIDDLE THIRD" / "FINAL THIRD"
  sibling sections were inconsistently H6/H2/H2 in the source —
  normalized all three to H4 as siblings under the Three Thirds H3.
  Also normalized "Here are some reasons why:" (H6→H4), "Obedient
  Responders" and "Church before 'Church?'" (both H6→H4). Converted 2
  plain-paragraph numbered sequences ("Step 1:"..."Step 6:" and
  "1. Reproducible"..."5. Accountable") into proper Markdown numbered
  lists. Converted 1 inline image to a relative path (confirmed
  present). Converted 3 internal links to relative paths: one to
  /movement-resources/12-practice-church-circle/ (real migrated
  tier-1 URL) and one to /unlock-biblical-principles-for-multiplying-
  disciples/ (confirmed tier-3, not yet migrated). The third —
  originally https://multiplyingdisciples.us/3-circles/ — was
  preserved pointing at /3-circles/ specifically, NOT the site's own
  /3-circles-guide/ hub: per PROTECTED_URLS.md, /3-circles/ is a real,
  separate, not-yet-migrated WordPress page (the actual "3 Circles"
  Google Slides tool), and conflating it with the hub slug would have
  been a wrong-slug error. External link to t4tglobal.org preserved
  exactly. Featured image pexels-photo-4051134.jpeg confirmed present.
---

Listen to the podcast episode: [Making Disciples (Spotify)](https://open.spotify.com/episode/2YCGz2kW9YV7eVdPGuBR75)
...
Multiplying disciples refers to the process of intentionally reproducing and equipping followers of Jesus to make new disciples, who in turn do the same. It involves sharing the gospel, teaching [biblical principles](/unlock-biblical-principles-for-multiplying-disciples/), and empowering others to continue the cycle of disciple-making.
...
With a few basic questions answered on discipleship and multiplying disciples, lets dive into 3 ways to make disciples.

Watch: [youtu.be/2eGXgEe7esk](https://youtu.be/2eGXgEe7esk)

### The Three Circles Gospel Tool

The Three Circles Gospel Tool ([click here to view Google Slides](/3-circles/)) is a simple way to share the Gospel and make disciples. It involves drawing three circles, with the first circle representing God's design, the second circle representing sin, and the third circle representing the Gospel.
...
1. **Draw three circles.** Start with a blank piece of paper and draw three circles. The three circles together form a circle representing the process of God bringing us back to His original design.
2. **Explain the first circle.** The first circle represents God's design. Explain that God created everything good and perfect, and He designed us to have a relationship with Him.
3. **Explain the second circle.** The second circle represents sin. Explain that sin entered the world when Adam and Eve disobeyed God, and it has corrupted everything. Sin separates us from God, and there's nothing we can do to fix it on our own.
4. **Explain the third circle.** The third circle represents the Gospel. Explain that the Gospel is the good news that God sent His Son, Jesus, to die on the cross for our sins. When we repent of our sins and put our faith in Jesus, we can be saved and have eternal life.
5. **Share your testimony.** After explaining the Gospel, share your testimony with the person you're talking to. Explain how you became a Christian and what Jesus has done in your life.
6. **Invite them to respond.** After sharing your testimony, invite the person to respond to the Gospel. Ask if they would like to pray with you and accept Jesus as their Savior.

Watch: [youtu.be/QfzP2qDv0UY](https://youtu.be/QfzP2qDv0UY)
...
Here is the format of a three thirds Bible study as laid out by the creators, Ying and Grace Kai ([T4T](https://www.t4tglobal.org/three-thirds-process#:~:text=The%20First%20Third%20should%20include,lesson%2C%20goal%20setting%20and%20prayer.)).
...
![Three Thirds Bible Study Process or Three-Thirds Process modeling look back, look up, and look forward.](/wp-content/uploads/2023/05/Screen-Shot-2023-04-02-at-7.11.17-AM-copy-2-1024x766.jpg)

Watch: [youtube.com/watch?v=s7OtcMpn1qU](https://www.youtube.com/watch?v=s7OtcMpn1qU)

### The Church Circle

The church circle ([click here to view Google Slides](/movement-resources/12-practice-church-circle/)) is indeed an effective model for short-term discipleship stories that can be used to train disciples to obey Jesus and identify as a church around the practice of those stories that correspond to the passage in Acts 2:36-47.
