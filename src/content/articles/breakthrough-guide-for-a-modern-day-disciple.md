---
title: "Breakthrough Guide For a Modern Day Disciple"
description: "Discover how embracing the path of a modern day disciple can ignite a movement of disciple makers, and change the world. Join the movement today."
slug: "/breakthrough-guide-for-a-modern-day-disciple/"
canonical: "https://multiplyingdisciples.us/breakthrough-guide-for-a-modern-day-disciple/"
hub: "disciple-making"
related_articles:
...
notes: >
  Migrated from WordPress post_id 7193. **Deferred/missing media
  (documented, non-blocking):** this page's only tracked media
  dependency is its featured image,
  ...
  `MEDIA_ACQUISITION_CHECKLIST.md` (only `-100x100` thumbnail crops
  were ever supplied, never the full-size original). The page body
  has zero inline images, so this only affects the `og_image` /
  social-share preview, not any visible on-page content — `og_image`
  is intentionally omitted from this file's frontmatter rather than
  pointing at a non-existent path. Revisit if the full-size file is
  ever supplied. Removed a duplicate H4 pull-quote near the top
  (closely paraphrasing the very next body sentence) and a second
  duplicate H4 near the end (repeating the Conclusion's opening
  sentence verbatim) — same chrome pattern removed across other Phase
  3/4 migrations. Removed the trailing raw-HTML "Are you in? / Start
  Here." Elementor CTA block and its embedded <style> tag, replaced by
  this article's own related_articles/related_tools mechanism.
  Promoted 3 plain-paragraph pseudo-headings ("Characteristics of a
  Modern Day Disciple," "Who is Called to be a Disciple?,"
  "Conclusion") to real H3 headings to match the parallel "Becoming a
  Modern Day Disciple" H3 elsewhere in the piece. Normalized 3 H6
  subheadings ("Characteristic #1/#2/#3") that sat directly under an
  H3 with no H4/H5 in between, promoting them to H4. Converted the
  numbered "7 Steps" sequence (previously 7 separate italicized
  paragraphs) into a proper Markdown numbered list. Converted 3
  absolute internal links to relative paths: /3-circles/ (the real,
  separate, not-yet-migrated "3 Circles" Google Slides tool page — not
  this site's own /3-circles-guide/ hub, per the same distinction
  established in the ridiculously-simple-3-ways migration),
  /disciple-making-resources-for-churches-that-will-multiply/
  (confirmed tier-3, not yet migrated), and /starter-tools/.
---
...
Following Jesus requires sacrifice, but it is also the most rewarding journey we can ever embark on.
...
You can also share the Gospel by [using a tool called the 3 Circles](/3-circles/) found on the Multiplying Disciples website. This tool has "gone viral" and [multiplied to many churches](/disciple-making-resources-for-churches-that-will-multiply/) and networks of disciples around the World.

#### Characteristic #3: They Disciple Others
...
Learn how to get started with [key simple starter tools](/starter-tools/) that will equip you to be effective, competent, and confident in your disciple-making.

### 7 Steps to Becoming a Modern-Day Disciple
...
4. Invest in others by discipling them and helping them grow in their faith. [Get started here.](/starter-tools/)
...
Another example is a man named John, who felt called to share the Gospel with his neighbors.
