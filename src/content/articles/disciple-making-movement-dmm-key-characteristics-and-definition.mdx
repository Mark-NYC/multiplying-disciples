...
While some argue that a DMM emphasizes disciples making disciples, while a CPM emphasizes church-planting churches, the concepts are similar enough for us to explore their essential characteristics. (For the church-first angle and David Garrison's definition, see [what is a church planting movement](/what-is-a-church-planting-movement/).)
...
<section id="listen-dmm" aria-label="Podcast: what actually starts disciple-making movements">

Listen to a researcher who has studied real movements up close explain what actually starts them, and the quiet things that secretly stop them.

<PodcastEmbed
  id="what-actually-starts-movements-and-what-secretly-stops-them-with-emmanuel-prinz"
  intro="Emmanuel Prinz has studied disciple-making movements as a researcher, not just a fan. In this episode he breaks down the spiritual and practical factors that actually start a movement, and the blockers, often in the leader, that quietly stop one."
/>
...
<ArticleMediaBar
  slug="/disciple-making-movement-dmm-key-characteristics-and-definition/"
  listen={{ target: 'listen-dmm', label: 'Listen' }}
