---
title: "The 3 Core Habits of a Disciple"
description: "Learn the 3 core habits of effective disciples: abiding in Christ, mapping your relationships, and sharing the gospel with simple tools that multiply movements."
slug: "/the-3-core-habits-of-a-disciple/"
...
notes: >
  Migrated from WordPress post_id 12869. Clean, well-structured prose,
  no chrome to remove besides a trailing reusable "Are you in? / Start
  Here." CTA block (wp:block ref 12760), dropped per established
  ...
  already-migrated tier-1 pages). Featured image (2025/01/3-5.jpg)
  confirmed present. 3 inline images (oikos-map-example.jpg,
  15-Second-Testimony-Format.jpg, 3-Circles-English-presentation.jpg,
  all in 2025/03) are missing — that month folder was supplied but only
  contains 2 unrelated files — dropped, surrounding prose kept intact.
---
...
> In this article you will learn the <span class="fm-underline fm-underline--shape-a fm-underline--clay">three foundational habits</span> that transform ordinary believers into disciple-makers who multiply movements.
...
- Learn [step by step how to share the 15 Second Testimony here](/15-second-testimony-examples-ignite-your-faith/)
...
- **Practice and Apply**
  - Learn the [step by step in how to share the 3 circles here](/the-three-circles-gospel-presentation-step-by-step/)
