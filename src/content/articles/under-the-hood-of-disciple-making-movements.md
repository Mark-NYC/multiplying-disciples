---
title: "Under the Hood of Disciple-Making Movements"
description: "The five elements and six shared principles behind Disciple-Making Movements (DMMs), and practical steps for how to be part of one."
slug: "/under-the-hood-of-disciple-making-movements/"
canonical: "https://multiplyingdisciples.us/under-the-hood-of-disciple-making-movements/"
...
notes: >
  Migrated from WordPress post_id 7897 (post). Fills the Church
  Planting Movements hub's previously-reserved "under-the-hood"
  key_articles slot. Removed 2 duplicate pull-quote-style headings
  that repeated adjacent paragraph text verbatim, stray Elementor
  <style> blocks, and the reusable "Are you in? / Start Here. / Get
  Started" promotional CTA block (same generic chrome removed across
  this batch). Converted the Spotify episode embed to a plain link.
  Converted absolute internal links (/three-thirds/, /3-circles/,
  /starter-tools/) to relative, and fixed /free-training (missing its
  trailing slash) to /free-training/. Featured image
  (weds-night-discipleship__1608243288.jpeg) and 2 inline supporting
  images (picture1-e1692189886892.jpeg with its figcaption, and
  Table-of-Math.jpeg) are missing from supplied uploads — all 3
  omitted (og_image left blank; the 2 inline figures dropped, with
  their surrounding prose left intact and still coherent without
  them). The Screen-Shot-2023-08-16 image is kept: the exact display
  size the original content used (1024x499) is present, even though
  the untouched full-size original is not. See
  PHASE_7B_TIER_3_BATCH_1.md for the full media/chrome breakdown.
---

[Listen to the related episode on Spotify](https://open.spotify.com/episode/24cPiWIltPnx5cF2kqkDk0)
...
## Elements of Disciple-Making Movements
...
2. **Study the Bible:** In a DMM, every disciple is a student of the Bible. Take time to study God's word and learn how you can apply it to your life and share it with others. [The Three Thirds process](/three-thirds/) is a key way to get started.
3. **Build Relationships and Share:** Disciple making is all about relationships. Get to know the people around you and look for opportunities to share your faith using a gospel tool with them. [The Three Circles](/3-circles/) is a gospel tool that has gone viral and has been used to see thousands come to faith.
...
5. **Get Equipped:** In a DMM, every disciple is equipped to make disciples. Take the time to learn how to share your faith effectively and how to disciple others. [Join an online training](/free-training/).
...
![Read 2 Timothy 2:2. The key to multiplication lies in investing deeply into the "right" leaders: those that are faithful with what they learn.](/wp-content/uploads/2023/05/Screen-Shot-2023-08-16-at-8.47.48-AM-1024x499.png)
