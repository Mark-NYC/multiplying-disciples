...
intro: >-
  One unique way of praying that many are finding effective at connecting
  prayer and missions, and that many have found to be particularly
  powerful, is prayer walking.
article_cta:
  type: lab
  placement: inline
