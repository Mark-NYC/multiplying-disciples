---
title: "Doctrinal Center & Theological Values"
description: "Our doctrinal center and theological values — beliefs statement covering Scripture, the Trinity, the Gospel, the Church, and the priesthood of all believers."
slug: "/beliefs-values/"
canonical: "https://multiplyingdisciples.us/beliefs-values/"
related_articles:
  - "/vision/"
  - "/movement-resources/"
related_tools: []
...
notes: >
  Migrated from WordPress post_id 5816 (page). Special inspection per
  Phase 7B Batch 4 instructions: genuine, clean doctrinal content
  written by Sentergy, linked from /vision/. Collapsed a duplicated
  <h2> title (export artifact — the title appeared twice in a row) into
  one heading. The intro's "*Download PDF below for Scripture
  References" has no actual link or attachment anywhere in the export
  (no postmeta attachment, no matching filename in supplied uploads) —
  kept as plain text rather than fabricating a destination. No hub
  assignment: this is the ministry's doctrinal statement, a core site
  page rather than one hub's specific topic — forcing it into a hub
...
This statement represents the doctrinal center or plumbline of Sentergy (and creators of Multiplying Disciples site). We offer these doctrinal statements as contributions for clarity and demonstrations of the scriptural shared theological values which keep the movement towards our true Center, Jesus and His mission. We invite you to join the movement until there is #NoPlaceLeft where the gospel has not been proclaimed. We also invite you to consistently search the scriptures as the Bareans to see if what we believe and practice are true.

*Download PDF below for Scripture References.
