...
<section id="listen-core-habits" aria-label="Podcast: the rhythms of a multiplier are caught, not hacked">

Listen to why these habits cannot be shortcut into your calendar, and how multiplying disciples actually catch them in the normal flow of life.

<PodcastEmbed
  id="the-rhythms-of-a-multiplier-cant-be-hacked-they-have-to-be-caught"
  intro="Habits are not tasks you bolt onto a busy week; they are rhythms you learn by living them near someone who already has them. Mark and Dave trace how the rhythms of a multiplier get caught, and why that changes how you grow the three habits below."
/>
...
<ArticleMediaBar
  slug="/the-3-core-habits-of-a-disciple/"
  listen={{ target: 'listen-core-habits', label: 'Listen' }}
