---
title: "5 T's Strategy Coordinator Overview"
...
notes: >
  Migrated from WordPress post_id 5988 (page, post_parent 2301 —
  confirmed genuine child of /movement-resources/, not an archive).
  One of 6 real, confirmed-but-unmigrated URLs identified as a Phase 8
  audit risk, resolved in Phase 9 (see
  PHASE_9_LINK_TARGETS_AND_HUB_STATUS.md). Real, substantial content —
  a "5 T's Strategy Coordinator Overview" plus a full "URLPEG
  Framework" section on urban mission targeting. Converted in-page
  anchor navigation ("BACK TO TOP" / jump links) to plain headings
  since Astro has no matching in-page nav component; converted an
  embedded YouTube video block to a plain link, kept the YouTube
  playlist link and 4 bit.ly podcast-episode links as documented
  external links, kept the Movements podcast link. Added to the
  /strategy-coordinator/ hub's key_articles (now 2, was 1). Featured
  image (2023/04/pexels-omar-lopez-1182825-1.jpg, a decorative header
  background) not found under supplied uploads — og_image kept
  pointing at the source path per convention despite being unconfirmed
  present. 1 inline image (68471e1fad432c1ff6f1c342ff450a0d.Target.webp)
  confirmed present.
---
...
This page covers what a strategy coordinator is, and the Head, Heart, Hands, and House of the strategy coordinator.
...
[Watch: What Is a Strategy Coordinator?](https://www.youtube.com/watch?v=ALDIe_Xp9uM)

*Join Dave Miller, Kyle Pierson, Mark Goering, and Carter Cox for a discussion into what a strategy coordinator is, how we train them, and why we need thousands of them in the mission field today. ([View the Full SC YouTube Playlist](https://www.youtube.com/playlist?list=PL1YoQQDZVDO5m72nTOJJW5FoKAlI6fHRU))*

### LEARN MORE: The Head, Heart, Hands, and House of the Strategy Coordinator

- Sparking CPMs: 4. House: [https://bit.ly/3AHcS4U](https://bit.ly/3AHcS4U)
- Sparking CPMs: 1. Head: [https://bit.ly/3KVguVJ](https://bit.ly/3KVguVJ)
- Sparking CPMs 2. Heart: [https://bit.ly/3G9Gf0X](https://bit.ly/3G9Gf0X)
- Sparking CPMs: 3. Hands: [https://bit.ly/3o6tpu6](https://bit.ly/3o6tpu6)

A short series of podcast episodes on the [Movements podcast with Steve Addison](https://www.movements.net/) is mentioned in this episode. Below are links to Steve's four interviews with "Barney" that unpack the role of the Strategy Coordinator.
...
![Target](/wp-content/uploads/2025/01/68471e1fad432c1ff6f1c342ff450a0d.Target.webp)
...
1. Begin with available data (census information, demographic studies)
2. Conduct focused research and community engagement
3. Develop targeted strategies for specific communities
4. Track progress and adjust approaches as needed
