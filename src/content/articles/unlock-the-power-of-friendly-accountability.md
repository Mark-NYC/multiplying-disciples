---
title: "Unlock the Power of Friendly Accountability"
description: "Don't miss out on the power of friendly accountability in Disciple Making Movements (DMM). Discover how to prioritize grace-based discipleship and avoid legalism."
slug: "/unlock-the-power-of-friendly-accountability/"
canonical: "https://multiplyingdisciples.us/unlock-the-power-of-friendly-accountability/"
hub: "disciple-making"
related_articles:
  - "/three-thirds/"
...
notes: >
  ...
  / Start Here. / Get Started" CTA block, a stray Elementor <style>
  block, and the [sibwp_form id=2] newsletter-signup shortcode section
  ("Four Fields of Kingdom Growth Action Guide") — converted to a
  plain CTA linking to the real migrated article
  /four-fields-of-kingdom-growth-starting-and-releasing-healthy-churches-by-nathan-and-kari-shank/
  instead of fabricating a form. Featured image
  (pexels-photo-2962229.jpeg) and one inline image (Friendly-
  Accountability-Checklist-for-Disciple-Making-Movements.png) not
  found under supplied uploads — og_image reassigned to the present
  Three-Thirds-Meeting-Format.webp inline image, and the missing
  checklist image dropped with its caption kept as plain text. The
...
**Accountability Prevents Legalism**
...
For example, some disciple makers use [the Three Thirds process](/three-thirds/) that includes in the meeting format a simple way to empower friendly accountability. Regular feedback and encouragement is built in that empowers disciples to grow in both "following Jesus" and "fishing for other."

![The Three Thirds Meeting Format](/wp-content/uploads/2023/05/Three-Thirds-Meeting-Format.webp)
...
This type of accountability is focused on building relationships and helping one another grow in obedience-based discipleship, rather than on enforcing rules and regulations.
...
3. Prioritize grace: Disciple making is not about perfection, but progress. When you prioritize grace and create a culture where it is safe to share struggles and failures, you create an environment where transformation can happen.
4. Use accountability tools: Accountability tools and processes such as [the Three Thirds](/three-thirds/) can be a helpful way to track progress and receive feedback from others.
...
Discover the Biblical process of starting and releasing healthy churches with the [Four Fields of Kingdom Growth Starter Guide](/four-fields-of-kingdom-growth-starting-and-releasing-healthy-churches-by-nathan-and-kari-shank/) – a FREE resource designed for existing Christians with a vision for the Great Commission.
