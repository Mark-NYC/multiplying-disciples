...
intro: >-
  Most discipleship groups die the same death: they meet for months,
  study Scripture, maybe pray together, then disband without producing a
  single disciple-maker.
article_cta:
  type: lab
  placement: inline
  stakes_headline: "Without a rhythm of practice and accountability, groups slowly become Bible studies that never multiply."
  bridge_copy: "Information alone doesn't change anyone. A lab turns what you know into something you can actually do, through practice with other people."
notes: >
...
<section id="watch-three-thirds" aria-label="Video: the Three Thirds meeting format">

Watch a short walkthrough of the Three Thirds meeting before you work through the breakdown below.

<div style={{ width: '100%', aspectRatio: '16 / 9', overflow: 'hidden', borderRadius: '12px' }}>
  <iframe
    src="https://www.youtube-nocookie.com/embed/Xc5pu-fSJSY"
    title="The Three Thirds meeting format, explained"
    loading="lazy"
...
**You skip practice** "We're running late, just practice at home." They won't. Next week no one shared. Solution: Trim the care time or shorten the lesson. Never cut practice.
...
**"We don't have 90 minutes"** That's fine, especially early on. Shorten the overall meeting and keep the three-thirds structure. But as your group grows you'll naturally push toward 90 minutes—or even two hours—and that's when it matters most to protect the parts that drive multiplication. Never shorten or cut **loving accountability** and **vision** in the first third, or **practice** and **goal-setting** in the last third. When you need to make room, trim the care time or shorten the lesson (the word time). Every part matters, but these four are what train people to actually obey Jesus and pass it on. Drop them and you're back to consumer Christianity.
...
<section id="listen-three-thirds" aria-label="Podcast: the vision-cast and Bible-study parts of the 3/3">

Listen to how two of the parts you just read about—the vision cast and the Bible study—actually propel discipleship when a leader runs them well.

<PodcastEmbed
  id="how-vision-casting-bible-study-propel-discipleship"
  intro="Is there a place for preaching in movement methods? Dave and Mark work through the function of each part of the Three Thirds process, zeroing in on the vision-cast and Bible-study thirds and how a leader can run them in a way that propels discipleship instead of stalling it."
/>
...
<ArticleMediaBar
  slug="/three-thirds/"
  watch={{ target: 'watch-three-thirds', label: 'Watch' }}
  listen={{ target: 'listen-three-thirds', label: 'Listen' }}
