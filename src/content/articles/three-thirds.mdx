...
<section id="listen-three-thirds" aria-label="Podcast: why we run scripture deep dives">

Listen to why the meeting is built to train, not just inform: a scripture deep dive teaches a group to see patterns, solve problems, and actually obey Jesus together.

<PodcastEmbed
  id="why-we-do-scripture-deep-dives-and-how-to-run-one"
  intro="Most Bible studies help people understand a passage. A scripture deep dive, the engine inside a Three Thirds meeting, trains a group to see patterns, wrestle real problems, and follow Jesus in daily life. Chuck Wood and Dave walk through why it works and how to run one."
/>
