---
title: "Breaking Down Barriers: Addressing Pastors' Objections to Disciple-Making Movements"
description: "Three common pastor objections to Disciple-Making Movements — that they aren't biblical, are too radical, or take too much time — and practical, biblical responses to each."
slug: "/breaking-down-barriers-addressing-pastors-objections-to-disciple-making-movements/"
...
notes: >
  Migrated from WordPress post_id 6885 (post). Fills the Church
  Planting Movements hub's previously-reserved "breaking down
  barriers" key_articles slot — the 4th and final open CPM slot,
  **completing that hub 8 of 8**. Removed a trailing reusable-block
  shortcode and a stray, doubly-escaped Elementor <style> block
  (same chrome patterns removed elsewhere in this batch). Otherwise
  clean modern Gutenberg-block content, no rewriting needed. Featured
  image (multiplication.jpeg) is present — already used as another
  migrated page's og_image too (the-power-of-multiplication article,
  Phase 4 Batch 3), no conflict, shared source photo. No inline
