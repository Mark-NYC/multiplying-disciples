...
**Most of these files have not been supplied yet.** Seven month folders
...
untracked size variants), and `2023/09` (5 files, 4 of 5 tracked rows
matched — 1 still missing) — see "Received uploads log" below. Every
...
- **Present so far: 104 of 171 tracked rows** (all 47 `2023/04` rows —
  ...
  1 A, 3 C. The `2023/02` upload landed on disk but didn't match this
  doc's one tracked row for that folder, and 1 `2023/09` row
